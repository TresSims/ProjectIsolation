	...
	"characters": [
		{
			...
			"portrait": "res://Content/Art/Characters/Starrietrie/T_StarretriPortrait.jpg",
			"body": "res://Content/Core/Characters/Starretri/Bodies/starrietrie.tscn",
			"item": "",
			"exp": 0,
			"level": 1,
			"locked": false,
		},
		{
			...
			"portrait": "res://Content/Art/Characters/Starglo/T_StargloPortrait.jpg",
			"body": "res://Content/Core/Characters/Starretri/Bodies/starglo.tscn",
			"item": "",
			"exp": 0,
			"level": 1,
			"locked": true,
		},
		{
			...
			"portrait": "res://Content/Art/Characters/Shiistar/T_ShiistarPortrait.jpg",
			"body": "res://Content/Core/Characters/Starretri/Bodies/shiistar.tscn",
			"item": "",
			"exp": 0,
			"level": 1,
			"locked": true,
